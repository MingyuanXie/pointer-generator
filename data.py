...
class Vocab(object):
  ...
  # 参数说明：vocab_file 是词表的文件位置，格式为每行词语 词频 虽然本段代码不会用到词频 max_size为最大词表大小
  def __init__(self, vocab_file, max_size):
    ...
    # 先生成unk，pad，start，stop与id的对应dict，分别对应0,1,2,3
